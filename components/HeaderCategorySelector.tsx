...
const HeaderCategorySelector = async () => {
    ...
    return (
        ...
        //         </svg>
        //     </div>
        //     <div className='absolute top-full left-0 invisible peer-hover:visible peer-hover:opacity-100 hover:visible hover:opacity-100 transition-all duration-100 z-10 '>
